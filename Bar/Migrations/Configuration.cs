    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Bar.Models.BarEntities>
    {
        ...
        protected override void Seed(Models.BarEntities context)
        {
            ...
            context.Units.AddOrUpdate(u => u.Title,
                ...
                new Unit { Title = "Groß", BaseFactor = 500, ShortTitle = "0.5L", CreatedById = user.Id, DateCreated = DateTime.Now },
                ...
                new Unit { Title = "Große Flasche", BaseFactor = 500, ShortTitle = "0.5 Fl", CreatedById = user.Id, DateCreated = DateTime.Now }
            );
